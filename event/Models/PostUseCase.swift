...
//    let collectionRef = Firestore.firestore().collection("clients").document().collection("posts")
//    
...
//            }
//            print("データ取得成功")
//            let clientCollection: [Post] = _snapshot.documents.compactMap{ (snapshot) in
